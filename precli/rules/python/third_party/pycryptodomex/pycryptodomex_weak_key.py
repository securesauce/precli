...
.. seealso::
 ...
 - `Inadequate Encryption Strength Using Weak Keys in PyCrypto Module <https://docs.securesauce.dev/rules/PRE0515>`_
...
class PycryptodomexWeakKey(Rule):
    ...
    def analyze(self, context: dict, **kwargs: dict) -> Result:
        ...
        if call.name_qualified == "Cryptodome.PublicKey.DSA.generate":
